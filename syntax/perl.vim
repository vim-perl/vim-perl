...
if !exists("perl_no_subprototype_error") " Set 1 if using signatures feature in perl5.19.9
    ...
    syntax match perlSignature "(.\{-})" nextgroup=perlSubAttributes contained
endif

syn match perlSubName +\%(\h\|::\|'\w\)\%(\w\|::\|'\w\)*\_s*\|+ contained nextgroup=perlSubPrototype,perlSignature,perlSubAttributes
