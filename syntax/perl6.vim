...
if exists("perl6_embedded_pir")
    ...
    syn match p6Quote_QPIR  display "Q[A-z(]\@!\%(\_s*:PIR\)\@=" nextgroup=p6Pairs_QPIR skipwhite skipempty
    syn match p6Pairs_QPIR contained "\_s*:PIR" transparent skipwhite skipempty nextgroup=p6String_QPIR
endif

for [start_delim, end_delim, end_group, skip] in s:delims
    exec "syn region p6String_Q matchgroup=p6Quote start=\"".start_delim."\" skip=\"".skip."\" end=\"".end_delim."\" contains=".end_group." contained"
    exec "syn region p6String_q matchgroup=p6Quote start=\"".start_delim."\" skip=\"".skip."\" end=\"".end_delim."\" contains=@p6Interp_q,".end_group." contained"
    exec "syn region p6String_qq matchgroup=p6Quote start=\"".start_delim."\" skip=\"".skip."\" end=\"".end_delim."\" contains=@p6Interp_qq,".end_group." contained"

    if exists("perl6_embedded_pir")
        exec "syn region p6String_QPIR matchgroup=p6Quote start=\"".start_delim."\" skip=\"".skip."\" end=\"".end_delim."\" contains=@p6PIR,".end_group." contained"
    endif
endfor
...
if version >= 508 || !exists("did_perl6_syntax_inits")
    ...
    HiLink p6String_Q        p6String
    HiLink p6String_q        p6String
    HiLink p6String_qq       p6String
    ...
    HiLink p6Quote_Q         p6Quote
    HiLink p6Quote_q         p6Quote
    HiLink p6Quote_qQ        p6Quote
    HiLink p6Quote_QPIR      p6Quote
